...
{
	private final static Logger logger = Logger.getLogger(ApplicationContextHelper.class);
    private static String XMLName = "classpath:applicationContext.xml";
    
    
    private static ApplicationContext applicationContext = null;
    // new ClassPathXmlApplicationContext("file:E:/fusion/intellij_work/TrunkNew/sss.xml");
    ...
    {         
        ...
        public static ApplicationContext Init() 
        {
            ...
            try 
            {
//            	context = new ClassPathXmlApplicationContext("file:D:\\workspace\\fmtest\\config\\applicationContext.xml");
            ...
            if (context == null) 
            {
                ...
                try
                {
                    ...
                    logger.debug("Spring配置文件路径："+fileName);
                    if (fileName != null)
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException 
    {
        ...
        logger.debug("ApplicationContextHelper setApplicationContext OK.");
    }
